...
_SYSTEM_PROMPT = (
    ...
    "ВНИМАНИЕ: Не склеивай код услуги (например, 250.028.003 или 45) и цену (например, 200) в одно гигантское число (250028003200)! "
    "Код запиши в поле `code` (с точками, как есть), а саму цену — в `price_resident` или `price_single`. "
    "Адекватная цена мед. услуги обычно не превышает 5 000 000. Если цена получается астрономической, значит ты склеил её с кодом или номером!"
