...
_SYSTEM_PROMPT = (
    ...
    "5. ПРОВЕРКА НА МЕДИЦИНСКУЮ ТЕМАТИКУ: Обязательно проверяй, относится ли извлеченная услуга к медицине, анализам или расходникам. Игнорируй услуги ресторана, меню кафе, парковки и прочий немедицинский мусор. Если услуга не имеет отношения к медицине — полностью ПРОПУСТИ эту строку. "
